    ...
    <header>
        <nav class="shadow-2xl">
            <div class="flex items-center justify-between px-4 py-2">
                <!-- Texte à gauche -->
                <span class="text-2xl text-green-500 font-bold mr-2 font-mono">Fredd<span class="text-blue-500">y</span></span>
                ...
                <div class="flex items-center">
                    ...
                    <?= isset($errors['ID_utilisateur']) ? $errors['ID_utilisateur'] : '' ?>
                </div>
            </div>
        </nav>
    </header>
    ...
    <section class="py-24">
        <div class="container mx-auto">
            <div class="flex justify-around">
                <div class="w-1/3 p-8 bg-white shadow-lg rounded-md mr-4 flex flex-col justify-between">
                    <div>
                    ...
                    <button type="button" class="bg-blue-500 hover:bg-blue-600 text-white font-bold rounded mt-4 p-2 font-mono">Je me forme en IA</button>
                </div>
                <div class="w-1/3 p-8 bg-white shadow-lg rounded-md ml-4 flex flex-col justify-between">
                    <div>
                    ...
                    <button type="button" class="bg-blue-500 hover:bg-blue-600 text-white font-bold rounded mt-4 p-2 font-mono">Je me forme en Cloud</button>
                </div>
            </div>
        </div>
    </section>
